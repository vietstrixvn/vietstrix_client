      ...
      <div ref={containerRef} className="mx-auto px-4 mb-20 w-full">
        ...
        >
          ...
          <video
            ...
            src={isIntersected ? "https://hcm03.vstorage.vngcloud.vn/v1/AUTH_161cb0839cf746f991ab035d9a50a0b6/vietstrix-team/video/Logo%20Intro.mp4" : undefined}
            muted={isMuted}
            playsInline
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className='flex flex-col'>
            <h3 className="font-semibold text-gray-900 text-base leading-snug">{mention.name}</h3>
            <p className="text-xs text-gray-500 mt-0.5">{mention.title}</p>
          </div>
        </div>

        {/* Right: Quote Icon */}
        <div className="text-3xl md:text-5xl font-bold text-main/80 select-none leading-none -translate-y-1">&quot;</div>
