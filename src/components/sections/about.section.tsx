          ...
          <div className="flex flex-col justify-center items-start lg:items-end lg:pr-12 order-2 lg:order-1">
            <div className="relative">
              ...
              <blockquote className="relative z-10 max-w-xl text-main">
                <p
                  ref={sloganRef}
                  className="text-4xl md:text-5xl lg:text-6xl font-bold uppercase text-lorenzo-text-light leading-[1.1] tracking-tight mb-8 flex flex-wrap gap-x-[0.25em] gap-y-[0.1em]"
                >
