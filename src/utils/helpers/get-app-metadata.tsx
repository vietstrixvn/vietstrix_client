...
export function getAppMetadata() {
  try {
    ...
    logError('[getAppMetadata] Error parsing invoice metadata:', error);
...
export function updateAppMetadata(updater: (current: Metadata) => Metadata) {
  try {
    ...
    if (!parsed.success) {
      logError('[updateAppMetadata] Validation error:', parsed.error);
    ...
    logError('[updateAppMetadata] Failed to save metadata:', error);
  }
}
